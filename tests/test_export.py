...
from scancode_required_phrases import export as export_module
from scancode_required_phrases import training
from scancode_required_phrases.export import check_viterbi_matches_crf
from scancode_required_phrases.export import export_crf_matrices
from scancode_required_phrases.export import export_onnx_emissions
from scancode_required_phrases.export import main
from scancode_required_phrases.export import _load_publishable_artifact
from scancode_required_phrases.export import OnnxDependencyError
from scancode_required_phrases.export import PARITY_CASES
...
def test_deterministic_adversarial_numpy_pytorch_parity(monkeypatch):
    ...
    monkeypatch.setattr(
        "scancode_required_phrases.export._training_interfaces",
        lambda: (
            ARTIFACT_SCHEMA,
            CONSTRAINT_CONTRACT,
            LABELS,
...
def test_cli_exposes_crf_and_onnx_as_separate_operations(tmp_path, monkeypatch):
    ...
    monkeypatch.setattr("scancode_required_phrases.export.export_crf_matrices", export_crf)
    monkeypatch.setattr("scancode_required_phrases.export.export_onnx_emissions", export_onnx)
    runner = CliRunner()
