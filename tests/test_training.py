...
from scancode_required_phrases import training
from scancode_required_phrases.training import align_labels
from scancode_required_phrases.training import AlignmentError
from scancode_required_phrases.training import ARTIFACT_SCHEMA
from scancode_required_phrases.training import build_effective_datasets
from scancode_required_phrases.training import compare_ordered_validation_results
from scancode_required_phrases.training import compute_metrics
from scancode_required_phrases.training import Config
from scancode_required_phrases.training import CONSTRAINT_CONTRACT
from scancode_required_phrases.training import decode_row
...
from scancode_required_phrases.training import IGNORE_INDEX
from scancode_required_phrases.training import LABEL2ID
from scancode_required_phrases.training import LABELS
from scancode_required_phrases.training import load_and_validate_splits
from scancode_required_phrases.training import main
from scancode_required_phrases.training import prepare_output_dir
from scancode_required_phrases.training import promote_final_model
from scancode_required_phrases.training import resolve_model_identity
from scancode_required_phrases.training import resolve_tokenizer_revision
from scancode_required_phrases.training import serializable_config
from scancode_required_phrases.training import sha256
from scancode_required_phrases.training import validate_bioes
from scancode_required_phrases.training import validate_config
from scancode_required_phrases.training import validate_publishable_model
from scancode_required_phrases.training import validate_record
from scancode_required_phrases.training import validate_saved_state
from scancode_required_phrases.training import validate_raw_split_hashes
from scancode_required_phrases.training import validate_state_dicts
from scancode_required_phrases.training import validate_state_structure
from scancode_required_phrases.training import write_failure_manifest
from scancode_required_phrases.training import write_json_atomic
...
def test_local_loader_loads_saved_values_after_structural_validation(monkeypatch, tmp_path):
    ...
    from scancode_required_phrases import model as model_module
...
def test_run_training_validates_every_raw_line_before_tokenizer_loading(monkeypatch, tmp_path):
    ...
    fake_model = types.ModuleType("scancode_required_phrases.model")
    ...
    monkeypatch.setitem(modules, "scancode_required_phrases.model", fake_model)
